    ...
    <section className="w-full p-2 max-w-[1100px] mx-auto">
      <div className="relative overflow-hidden rounded-lg">
        <img
          src={img}
          alt=""
          className="w-[700px]  h-[200px] sm:h-[300px] md:h-[550px] object-cover"
        />
        <div className="md:absolute bottom-6 right-0 bg-white p-4 md:p-8 w-full md:w-[550px] h-auto md:h-[420px] lg:h-[400px] flex flex-col justify-center shadow-lg">
          <p className="text-sm leading-relaxed md:text-base lg:text-lg">
            Small descriptive text in 3-4 lines can <br />
            go here. They can be a single line <br />
            or short paragraph too. Small descriptive <br />
